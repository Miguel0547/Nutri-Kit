...
```
cd existing_repo
git remote add origin https://kgcoe-git.rit.edu/2215-swen-344-01/client-group-19/client-mar6466.git
git branch -M main
...
- [ ] [Set up project integrations](https://kgcoe-git.rit.edu/2215-swen-344-01/client-group-19/client-mar6466/-/settings/integrations)
...
React Application - run the command "npm run start" from inside the /abc123-react folder to run application.
